...
import 'package:drift/internal/versioned_schema.dart'; // <- import for VersionedSchema
          ...
          () => VersionedSchema.runMigrationSteps(
            ...
            steps: migrationSteps(
              ...
              from1To2: (Migrator m, Schema2 schema) async {
                ...
                await m.addColumn(schema.taskTable, schema.taskTable.location);
                await m.addColumn(schema.taskTable, schema.taskTable.isUrgent);

                /// Add new columns to [AttendantTable]
                await m.addColumn(
                  schema.attendantTable,
                  schema.attendantTable.department,
                );
              },
            ),
          ),
